        ...
        <div className="column">
          <div className="row align-center">
            ...
            <div className="column small-12 medium-4 large-6">
              <a href="/" className="logo need-highlight in-footer" aria-label="DISEÑO TU PÁGINA WEB ULTIMA Tecnologías Web FRONT-END DEVELOPER&reg;." target="_blank" rel="noopener noreferrer">
              ...
              <address>
                <p className="no-margin"><b><strong><span>Lino Adrián Páez Reyes</span></strong></b> - DISEÑO TU PÁGINA WEB ULTIMA Tecnologías Web FRONT-END DEVELOPER&reg;.</p>
            ...
            <div className="column medium-9 medium-offset-0 large-offset-6 large-6">
              <p className="copyright">
                <small>
                  ...
                  </strong>. │ <br /><b>Todos Los Derechos Reservados.</b><br />
                </small>
              </p>
            </div>
          </div>
