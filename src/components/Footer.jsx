...
const Footer = () => {
  return (
    <>
      <footer className="row align-middle expanded white">
        <div className="column">
          <div className="row align-center">
            <div className="column small-12 medium-5 medium-offset-0 large-4 large-offset-2">
              <a href="/mentionslegales" className="button big highlight in-footer" data-dot="contrast" target="_blank" rel="noopener noreferrer">
                <span className="arrow" /><b><strong>Términos y Condiciones.</strong></b>
              </a>
            </div>
            <div className="column small-12 medium-4 large-6">
              <a href="/" className="logo need-highlight in-footer" aria-label="DISEÑO TU PÁGINA WEB ULTIMA Tecnologías Web FRONT-END DEVELOPER&reg;. &#124; Colombia." target="_blank" rel="noopener noreferrer">
              ...
              <address>
                <p className="no-margin"><b><strong><span>Lino Adrián Páez Reyes</span></strong></b> - DISEÑO TU PÁGINA WEB ULTIMA Tecnologías Web FRONT-END DEVELOPER&reg;. &#124; Colombia.</p>
                <p className="no-margin">
                  <a href="mailto:apr.1991lino@gmail.com" className="highlight in-footer" rel="noopener noreferrer">
                    apr.1991lino@gmail.com
                  </a>
                </p>
              </address>
            </div>
          ...
          <div className="row align-center">
            <div className="column medium-9 medium-offset-0 large-offset-6 large-6">
              <p className="copyright">
                <small>
                  ...
                  <strong>
                    <span>
                      &#124; <b>DISEÑO TU PÁGINA WEB ULTIMA Tecnologías Web FRONT-END DEVELOPER&reg;.</b>
                    </span>
                  </strong> &#124; Colombia.<br /><b>Todos Los Derechos Reservados.</b><br />
                </small>
              </p>
            </div>
          </div>
