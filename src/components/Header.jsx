  ...
  return (
    <>
      <div id="awwwards" className="nominee green right">
        <a href="/" target="_blank" rel="noopener noreferrer">Awwwards.</a>
      </div>
      ...
      <header className="row expanded collapse align-justify">
        <div className="column shrink">
          <div className="row collapse align-middle">
            ...
            <div className="column">
              <nav>
                <label for="trigger" className="menu-button show-for-small-only">
                  <span></span>
                </label>
                <ul className="menu">
                  <li>
                    <a href="/lestudio" data-dot="contrast" className="need-highlight highlight in-footer" target="_blank" rel="noopener noreferrer">
                      Estudio.
                    </a>
                  </li>
                  <li>
                    <a href="/nosservices" className="need-highlight highlight in-footer" target="_blank" rel="noopener noreferrer">
                      Servicios.
                    </a>
                  </li>
                </ul>
        ...
        <div className="column shrink hide-for-small-only">
          <ul className="lang">
            <li className="active">
              <a href="/" className="need-highlight highlight in-footer" target="_blank" rel="noopener noreferrer">
                Inicio.
              </a>
            </li>
          </ul>
        ...
        <div className="menu mobile">
          ...
          <ul>
            <li className data-target="studio">
              <a href="/lestudio" className="highlight in-footer" data-dot="contrast" target="_blank" rel="noopener noreferrer">
                Estudio.
              </a>
            </li>
            <li className data-target="services">
              <a href="/nosservices" className="highlight in-footer" target="_blank" rel="noopener noreferrer">
                Servicios.
              </a>
            </li>
            <li className="active" data-target="index">
              <ul className="lang">
                <li className="active">
                  <a href="/" className="index highlight in-footer" target="_blank" rel="noopener noreferrer">
                    Inicio.
                  </a>
                </li>
              </ul>
              <ul className="social">
                ...
                <li>
                  <a href="#!" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                    <svg>
                      <use xlinkHref="picture/sprite.svg#logo-twitter" />
                    </svg>
                  </a>
                </li>
                <li>
